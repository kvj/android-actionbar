...
final class ListNavigationDropdown extends PopupWindow {
	public static class Builder implements View.OnClickListener {
		...
		public Builder setAdapter(SpinnerAdapter adapter,
		...
		public void show() {
			...
			View contentView = inflater.inflate(
					R.layout.actionbar_list_dropdown, null, false);

			LinearLayout list = (LinearLayout) contentView
					.findViewById(R.id.actionbar_list_dropdown);
